...
opns = neuprint_read_neuron_simple(opn.info$bodyid)
...
### multiple times. This is because there is a separate entry for each of FlyEM's designated
### regions of interest (ROIs). You need to sum across the different ROIs for each pairing, in
### order to get your unitary connection strength between two neurons.
